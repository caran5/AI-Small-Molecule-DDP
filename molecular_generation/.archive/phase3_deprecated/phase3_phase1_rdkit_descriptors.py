...
print("="*80)
print("PHASE 3 PHASE 1: RDKit Descriptors (Feature Engineering)")
print("Test: Can better features jump from 50% → 55-65% accuracy?")
print("="*80)
...
if len(X_orig) == 0:
    print("❌ Failed to load molecules!")
    sys.exit(1)

print(f"✅ Extracted {len(X_orig)} molecules")
...
if success_enh >= success_orig + 0.05:
    ...
    decision = "→ Diagnose: feature quality or overfitting issue"
